...
var anime = function() {
    var t = {
        ...
        update: void 0,
        complete: void 0
    }, e = ["translateX", "translateY", "translateZ", "rotate", "rotateX", "rotateY", "rotateZ", "scale", "scaleX", "scaleY", "scaleZ", "skewX", "skewY"], r = function() {
        return {
            array: function(t) {
        ...
        var a = {};
        if ("transform" === e)
            a.from = t + "(" + b(t, n.from, n.to) + ")", a.to = t + "(" + b(t, n.to) + ")";
        else {
